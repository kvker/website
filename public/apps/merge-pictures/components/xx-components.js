const xxToast = document.createElement('xx-toast')
document.body.append(xxToast)
Alpine.morph(
  xxToast,
  `<div x-data="{
        notifications: [],
            ...
            <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
              ...
              <div class="flex w-full items-center gap-2.5 bg-sky-500/10 rounded-md p-4 transition-all duration-300">
                ...
                <div class="flex flex-col gap-2">
                  ...
                  <p x-cloak x-show="notification.message" class="text-pretty text-sm" x-text="notification.message">
                  </p>
                </div>
            ...
            <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
              ...
              <div
                ...
                <div class="flex w-full items-center gap-2.5">
                  ...
                  <!-- Avatar -->
                  <img x-cloak x-show="notification.sender.avatar" class="mr-2 size-12 rounded-full" alt="avatar"
                    aria-hidden="true" x-bind:src="notification.sender.avatar" />
                  <div class="flex flex-col items-start gap-2">
                    <!-- Title & Message -->
                    <h3 x-cloak x-show="notification.sender.name"
                      class="text-sm font-semibold text-neutral-900 dark:text-white" x-text="notification.sender.name">
                    </h3>
                    <p x-cloak x-show="notification.message" class="text-pretty text-sm" x-text="notification.message">
                    </p>
